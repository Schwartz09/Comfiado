...
public class MeDevemActivity extends AppCompatActivity {
    ...
    private void mostrarDividas() {
        ...
        ArrayAdapter<Divida> adaptador = new ArrayAdapter<>(MeDevemActivity.this, android.R.layout.simple_list_item_1,dividas);
    ...
    private void trocarParaActivityMain() {
        Intent i = new Intent(MeDevemActivity.this, MainActivity.class);
        startActivity(i);
        finish();
    }
}